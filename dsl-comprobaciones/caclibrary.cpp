...
void checkCode::check()
{
  ...
  llvm::Expected<clang::tooling::CommonOptionsParser> OptionsParser = CommonOptionsParser::create(argc2, argv2, MyToolCategoryExe);
...
#if __clang_major__ >=14
  llvm::Expected<clang::tooling::CommonOptionsParser> OptionsParser = CommonOptionsParser::create(argc1, argv1, MyToolCategoryFind);
